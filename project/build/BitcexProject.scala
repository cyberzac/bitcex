...
class BitcexProject(info: ProjectInfo) extends DefaultWebProject(info) with AkkaProject {
  ...
  val camel_core = "org.apache.camel" % "camel-core" % camel_version
  val camel_scala = "org.apache.camel" % "camel-scala" % camel_version
  val camel_servlet = "org.apache.camel" % "camel-servlet" % camel_version
  val camel_spring = "org.apache.camel" % "camel-spring" % camel_version
